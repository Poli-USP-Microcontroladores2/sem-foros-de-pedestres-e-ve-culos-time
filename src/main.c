...
/* Semáforo para a vez da Thread A (Verde) - Começa com permissão (1) */
K_SEM_DEFINE(semáforo_verde, 1, 1); 
/* Semáforo para a vez da Thread B (Vermelho) - Começa bloqueada (0) */
K_SEM_DEFINE(semáforo_vermelho, 0, 1); 
...
void thread_verde(void *p1, void *p2, void *p3)
{
    ...
    while(1){
        ...
        k_sem_take(&semáforo_verde, K_FOREVER);
...
void thread_vermelho(void *p1, void *p2, void *p3)
{
    ...
    while(1){
        ...
        k_sem_take(&semáforo_vermelho, K_FOREVER); 
